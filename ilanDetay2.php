...
$sonuc=mysqli_query($baglan,"select * from mesajlar where GonderenK like '%$ad' and  ilanNo='$id'"); 

$sonuc2=mysqli_query($baglan,"select * from soru where AliciK like '%$ad' and GonderenK like'%$select5' and  ilanNo='$id'");
$sonuc3=mysqli_query($baglan,"select * from cevap where GonderenK like '%$ad' and AliciK like'%$select5' and  ilanNo='$id'");  
...
?>
 ...
 <select  type="text" name="select5" id="select5">
  ...
  <input type="text2" name="Soru" placeholder="Cevabınız ">
  <input type="submit2" name="soruyuSor" value="Cevabı Yolla">
...
$sqlekle="INSERT INTO cevap(GonderenK,AliciK,cevabi,ilanNo) 
