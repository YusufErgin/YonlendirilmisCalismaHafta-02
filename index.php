...
if(isset($_GET["islem"]))
	{
		...
		switch ($islem)
		{
                       ...
                       case "sil": 
$baglan=mysqli_connect("localhost","root","","yuva");
$sonuc=mysqli_query($baglan,"select * from ilan   where Durum='0' and Onay='1'  order by llanId asc limit 4,4"); 
$satirr=mysqli_num_rows($sonuc);
mysqli_set_charset($baglan, "utf8");
if($satirr<=0) { echo "<h>  </h>"; return; }
$sutun=0;
...
<br>
<br>
   <div align="center">Sayfa<a href='index.php?islem2=sil'>1 -> </a> <a href='index.php?islem=sil'>2 -> </a>  <a href='index.php?islem3=sil'>3 -> </a></div></p>
</div>		
		<!-- FOOTER -->
		<footer>
			<div class="wrapper cf">
