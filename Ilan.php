		...
		<div id="main">
			...
			<div class="home-featured">
				<ul id="filter-buttons">
					<li><a href="#" data-filter="*" class="selected">İlan Ver</a></li>
...
"<option>Tür Seçin</option>";
        <?php
         ...
         {
         echo "<option value=".$Turi["Turin"].">".$Turi["Tur"]."</option>";
...
<select type="text" name="select3" id="select3"></select>
...
<input type="text" name="yas" placeholder="Yas">
<input type="text" name="AsiBilgisi" placeholder="Asi Bilgisi">
<input type="file" name="dosya" id="dosya">
  <input type="submit" name="uye" value="İlan Ver">
...
if(empty($select2) || empty($ad)|| empty($select)|| empty($yas)|| empty($AsiBilgisi)|| empty($dosya) || empty ($select3)){
...
VALUES ('$select2','$ad','$select','$yas','$AsiBilgisi','$resim','1','$as','0','$select3')";
