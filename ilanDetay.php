...
.box2 input[type = "text2"],.box input[type = "password"]{
  border:0;
  background: none;
  display: block;
  margin: 42px auto;
...
?>
 ...
 <form class="box2"  method="post">
  ...
  <textarea  type="text" name="mesajlar" placeholder="">

<?php
if(isset($_POST["mesaj"])){ extract($_POST);
$ad=$_SESSION["kullanici"];
$baglan=mysqli_connect("localhost","root","","yuva");

$sonuc=mysqli_query($baglan,"select * from mesajlar where GonderenK like '%$select5' and  ilanNo='$id'"); 
$sonuc3=mysqli_query($baglan,"select * from soru where GonderenK like '%$ad' and AliciK like'%$select5' and  ilanNo='$id'"); 
$sonuc2=mysqli_query($baglan,"select * from cevap where AliciK like '%$ad' and GonderenK like'%$select5' and  ilanNo='$id'"); 
$satirr=mysqli_num_rows($sonuc2);
$satirr=mysqli_num_rows($sonuc);
mysqli_set_charset($baglan, "utf8");
...
echo " ".$satir['GonderenK']." :  ".$satir['Mesaj']." 
 ".$satir['GonderenK']." :  ".$satir['ilanNo']." No'lu İlanı ".$satir['Mesaj2']."
 ".$satir['AliciK'].":   ".$satir['SSor']." 
 ".$satir['GonderenK']." :  ".$satir['soru']." 
 ";
...
echo "".$satir['GonderenK'].":   ".$satir['soru']."--  ".$satir['tarih']."    
 ";
...
echo "".$satir['GonderenK']." :  ".$satir['cevabi']."--  ".$satir['tarih']." 
 ";
...
<select type="text" name="select5" id="select5">
        <?php
         $baglan=mysqli_connect("localhost","root","","yuva"); 
         mysqli_set_charset($baglan, "utf8");
         $sorgu=mysqli_query($baglan,"Select * from mesajlar where ilanNo='$id'");
  ...
  <input type="submit" name="mesaj" value="Mesajları Dök">
  <input type="text2" name="Soru" placeholder="Sorunuz">
  <input type="submit2" name="soruyuSor" value="Soruyu Yolla">

</form>                                                       

<?php

 if(isset($_POST["soruyuSor"])){ extract($_POST);
...
$sqlekle="INSERT INTO soru(GonderenK,AliciK,soru,ilanNo) 
VALUES ('$ad','$select5','$Soru','$id')";
